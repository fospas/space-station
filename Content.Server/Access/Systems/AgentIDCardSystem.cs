...
namespace Content.Server.Access.Systems
{
    public sealed class AgentIDCardSystem : SharedAgentIdCardSystem
    {
        ...
        [Dependency] private readonly SharedNanoChatSystem _nanoChat = default!; // Cats-PDAChat
        ...
        public override void Initialize()
        {
            ...
            SubscribeLocalEvent<AgentIDCardComponent, AgentIDCardNumberChangedMessage>(OnNumberChanged); // Cats-PDAChat
        }

        // Cats-PDAChat - Add number change handler
        ...
        private void OnAfterInteract(EntityUid uid, AgentIDCardComponent component, AfterInteractEvent args)
        {
            ...
            // Cats-PDAChat-Start - Copy NanoChat data if available
        ...
        private void AfterUIOpen(EntityUid uid, AgentIDCardComponent component, AfterActivatableUIOpenEvent args)
        {
            ...
            // Cats-PDAChat-Start - Get current number if it exists
            ...
            var state = new AgentIDCardBoundUserInterfaceState(
                ...
                idCard.JobIcon,
                currentNumber); // Cats-PDAChat-End - Pass current number

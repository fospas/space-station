using Content.Shared.Backmen.BluespaceHarvester;
using JetBrains.Annotations;

namespace Content.Client.Backmen.BluespaceHarvester;
...
public sealed class BluespaceHarvesterBoundUserInterface : BoundUserInterface
{
    ...
    public void SendBuy(Shared.Backmen.BluespaceHarvester.BluespaceHarvesterCategory category)
    {
